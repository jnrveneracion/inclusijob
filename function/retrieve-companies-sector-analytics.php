...
$sql = "SELECT industry_sector, COUNT(employer_id) AS employer_count FROM JOB_LISTING LEFT JOIN EMPLOYER_SIGNUP_INFO ON JOB_LISTING.employer_id = EMPLOYER_SIGNUP_INFO.company_ID GROUP BY employer_id ORDER BY employer_count DESC LIMIT 3;";
...
if (mysqli_num_rows($result) > 0) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo '<div class="d-flex align-items-start">
                    ...
                    <p class="list mb-0 ms-2">' . $row['industry_sector'] . '</p>
               </div>';
    }
