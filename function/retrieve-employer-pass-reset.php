...
$query = "SELECT 
          ...
          LEFT JOIN EMPLOYER_SIGNUP_INFO
          ON EMPLOYER_SIGNUP_INFO.company_ID = REQUEST_RESET_PASSWORD.user_ID
          WHERE REQUEST_RESET_PASSWORD.user_type = 'Employer'";
     ...
     while ($row = mysqli_fetch_assoc($result)) {
          ...
          echo '<tr>';
               ...
               echo '<td class="position-relative">
                         ...
                         <button style="top: 31%; right: 12px;" class="d-none position-absolute btn-copy-password ' . $svgCopyShow . '">' . $svgCopy . '</button>
                    </td>';
          echo '</tr>';
     }
