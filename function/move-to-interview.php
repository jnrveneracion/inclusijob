...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "UPDATE JOB_APPLICATION_STATUS SET interview = ?, interview_date = NOW() WHERE jobseeker_ID = ? AND company_ID = ? AND job_ID = ?";
    ...
    if ($stmt->execute()) {
        ...
        header("Location: ../employer/job-application-review.php?tab=" . $tab . "&j=" . $jobListingId . "&message=You%20have%20successfully%20moved%20" . $jobSeekerName . "%20to%20interview");
        exit();
    } else {
