     ...
     <body class="container-xxl">
          ...
          <div class="breadcrumbs">
               <div class="page-indicator d-flex justify-content-center justify-content-lg-start">
                    ...
                    <a href="job-seeker/job-seeker-login.php" class="no-decor-link">
                         <h6 class="page-indicator-txt">Job Seeker Login</h6>
                    </a>
                    <a href="" class="no-decor-link">
                         <h6 class="page-indicator-txt divider">></h6>
                    </a>
                    <a href="#" class="no-decor-link">
                         <h6 class="page-indicator-txt active">Job Seeker Request Password Reset</h6>
                    </a>
               </div>
          </div>
          ...
          <script>
               function submitForm() {
                    ...
                    xhr.open('POST', 'function/process-reset-request-job-seeker.php', true);
