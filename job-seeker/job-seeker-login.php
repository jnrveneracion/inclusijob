                         ...
                         <div class="">
                              <div class="d-grid justify-content-center align-items-center">
                                   <form action="" method="post" class="d-grid justify-content-center align-items-center">
                                        ...
                                        <a href="../request-reset-password-job-seeker.php" class="text-center login-footer" style="font-size: 13px; text-decoration: none; font-weight: 500; letter-spacing: 1px;"><span class="">Forgot password?</span></a>
                                        <button type="submit" class="login-btn">LOGIN</button>
                                   </form>
                                   <hr>
                                   <p class="mt-1 mb-1" style="letter-spacing: .6px; margin: 0px 7%; font-size: 13px;">New to InclusiJob? <a href="job-seeker-signup.php" style="font-weight: 600; color: color(srgb 0.1303 0.5184 0.9668);"><span class="">Join now</span></a></p>
                              </div>
                         </div>
