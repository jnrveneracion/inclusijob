...
<body class="container-xxl">
     ...
     <div class="breadcrumbs">
          <div class="page-indicator d-flex justify-content-center justify-content-lg-start">
               ...
               <a href="preview-profile.php" class="no-decor-link"><h6 class="page-indicator-txt">Preview Profile</h6></a> 
               <a href="#" class="no-decor-link"><h6 class="page-indicator-txt divider">></h6></a>
               <a href="#" class="no-decor-link"><h6 class="page-indicator-txt active">Preview Resume</h6></a> 
          </div>
     </div>
